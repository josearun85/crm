...
var rn = Object.freeze(Object.defineProperty({ __proto__: null, addClassName: wt, closest: ct, getActiveElement: ge, getChildNodes: tn, getClassName: X, getClosestSizedElement: nn, getFocusableNodes: Lt, getNodePosition: V, getRelativeEventPosition: rt, getRelativeNodePosition: en, getRootNode: vt, getScrollSize: Xe, getTargetNode: yt, hasClass: function(t, e) {
  ...
  return !!vt(t);
}, insertNode: Ze, isChildOf: Y, isShadowDomSupported: an, locateAttribute: et, locateClassName: pt, removeClassName: Gt, removeNode: Qe, toNode: we }, Symbol.toStringTag, { value: "Module" }));
var dt = typeof window < "u" ? window : global;
var Nn = class {
  constructor(t) {
  ...
  attach(t, e, n) {
    ...
    this._domEvents.attach(l, "mouseup", (p) => {
      ...
      this._touchStarts = true, this._longTapTimer = setTimeout(() => {
        this._touchStarts && (u(d(p)), this._touchStarts = false, this._touchActive = true);
      }, this._gantt.config.touch_drag);
    }), this._domEvents.attach(l, "touchend", (p) => {
      this._touchStarts = false, this._touchActive = false, clearTimeout(this._longTapTimer), h(d(p));
    ...
    const c = () => {
      ...
      s = null;
      let y = c();
      y && i.utils.dom.closest(p.target, y) || (r.registerProvider("clickDrag", () => ({ autoscroll: this._mouseDown })), e && p[e] !== true || (s = this._getCoordinates(p, t)));
    }, h = (p) => {
      if (s = null, (!e || p[e] === true) && this._mouseDown === true) {
        this._mouseDown = false;
        const y = this._getCoordinates(p, t);
        t.dragEnd(y);
      }
    }, g = (p) => {
      if (e && p[e] !== true) return;
      ...
      this._mouseDown === true && (b = this._getCoordinates(p, t), t.setEnd(b), t.render());
    };
  }
  detach() {
    const t = this._gantt;
...
var Yt = class _Yt {
  constructor(e) {
    this._mouseDown = false, this._calculateDirectionVector = () => {
      ...
      this._mouseDown = false, te = false;
    }, this._startDrag = (n) => {
      const i = this._gantt;
      this._originAutoscroll = i.config.autoscroll, i.config.autoscroll = false, te = true, i.$root.classList.add("gantt_noselect"), this._originalReadonly = i.config.readonly, i.config.readonly = true, i.config.drag_timeline && i.config.drag_timeline.render && i.render(), this._trace = [], this._mouseDown = true;
...
var Bn = Object.freeze(Object.defineProperty({ __proto__: null, bind: R, copy: q, defined: W, event: on, eventRemove: ln, mixin: P, uid: st }, Symbol.toStringTag, { value: "Module" }));
function Se(t, e) {
  t = t || on, e = e || ln;
...
var Ie = { onBeforeUndo: "onAfterUndo", onBeforeRedo: "onAfterRedo" };
var Me = ["onTaskDragStart", "onAfterTaskUpdate", "onAfterParentExpand", "onAfterTaskDelete", "onBeforeBatchUpdate"];
var jn = class {
  constructor(e, n) {
  ...
  _attachEvents() {
    ...
    for (const l in Ie) n.attachEvent(l, () => (this.startIgnore(), true)), n.attachEvent(Ie[l], () => (this.stopIgnore(), true));
    for (let l = 0; l < Me.length; l++) n.attachEvent(Me[l], () => (this.startBatchAction(), true));
...
var Vn = { click_drag: function(t) {
  t.ext || (t.ext = {});
  const e = { className: "gantt_click_drag_rect", useRequestAnimationFrame: true, callback: void 0, singleRow: false };
  function n() {
  ...
  t.ext || (t.ext = {}), t.ext.dragTimeline = { create: () => Yt.create(t), _isDragInProgress: () => Yt._isDragInProgress }, t.config.drag_timeline = { enabled: true, render: false };
  ...
  (function(e) {
    e.config.keyboard_navigation = true, e.config.keyboard_navigation_cells = false, e.$keyboardNavigation = {}, e._compose = function() {
      ...
      var i = function(v) {
        ...
        if (b && !v) {
          var _, m, f = b.getNode();
          f && f.parentNode && (_ = f.parentNode.scrollTop, m = f.parentNode.scrollLeft), b.focus(true), f && f.parentNode && (f.parentNode.scrollTop = _, f.parentNode.scrollLeft = m);
        }
      };
      function s(v) {
          ...
          e._smart_render._redrawTasks = function(b, _) {
            if (e.config.keyboard_navigation && n.isEnabled()) {
              ...
              if (m && m.taskId !== void 0) {
                for (var f = false, k = 0; k < _.length; k++) if (_[k].id == m.taskId && _[k].start_date) {
                  f = true;
                  break;
                }
      ...
      e.attachEvent("onTaskCreated", function(v) {
        ...
        if (n.isEnabled()) {
          ...
          b.type == e.config.types.placeholder && e.config.placeholder_task.focusOnCreate === false || n.setActiveNode(new f(v, _));
        }
  ...
  t.config.multiselect = true, t.config.multiselect_one_level = false, t._multiselect = { _selected: {}, _one_level: false, _active: true, _first_selected_when_shift: null, getDefaultSelected: function() {
    ...
    t.selectTask = function(i) {
      if (!(i = at(i, this.config.root_id))) return false;
...
function xt(t, e) {
  ...
  if (e.length === 1) return typeof e[0] == "string" ? (n.url = e[0], n.async = true) : (n.url = e[0].url, n.async = e[0].async || true, n.callback = e[0].callback, n.headers = e[0].headers), e[0].data ? typeof e[0].data != "string" ? n.data = Ne(e[0].data) : n.data = e[0].data : n.data = "", n;
  switch (n.url = e[0], t) {
    case "GET":
    case "DELETE":
...
var Pe = { date_to_str: (t, e, n) => (i) => t.replace(/%[a-zA-Z]/g, (a) => {
  switch (a) {
    case "%d":
...
var Kn = function() {
  ...
  return { getState: function(e) {
    ...
    var n = {};
    for (var i in t) t[i].internal || P(n, t[i].method(), true);
    return n;
...
var it = function(t) {
  return this.pull = {}, this.$initItem = t.initItem, this.visibleOrder = tt.$create(), this.fullOrder = tt.$create(), this._skip_refresh = false, this._filterRule = null, this._searchVisibleOrder = {}, this._indexRangeCache = {}, this._getItemsCache = null, this.$config = t, ot(this), this._attachDataChange(function() {
...
it.prototype = { _attachDataChange: function(t) {
  ...
  P(this.pull[t], e, true), this.isSilent() || (this.callEvent("onAfterUpdate", [e.id, e]), this.callEvent("onStoreUpdated", [e.id, e, "update"]));
  ...
  return W(t.id) || (t.id = st()), this.$initItem && (t = this.$initItem(t)), !(!this.isSilent() && this.callEvent("onBeforeAdd", [t.id, t]) === false) && (this._addItemInner(t, e), this.isSilent() || (this.callEvent("onAfterAdd", [t.id, t]), this.callEvent("onStoreUpdated", [t.id, t, "add"])), t.id);
  ...
  var n, i;
  if (!this.$destroyed && !this.isSilent() && (t && (n = this.getItem(t)), i = t ? [t, n, "paint"] : [null, null, null], this.callEvent("onBeforeStoreUpdate", i) !== false)) {
...
cn.prototype = P({ _buildTree: function(t) {
  ...
  for (; n && this.exists(i); ) {
    if ((n = this.getItem(i)) && lt(n.id, e)) return true;
    i = this.getParent(n);
  }
  return false;
  ...
  W(e) || (e = n);
  var i = at(e, n) || n, a = false, r = false, s = null;
...
var ve = { getSubtreeLinks: function(t, e) {
  var n = {};
...
var ei = class {
  ...
  attach() {
    ...
    this._dataProcessorHandlers.push(n.attachEvent("onAfterTaskAdd", function(o, l) {
      ...
      return n.config.cascade_delete && (i[o] = { tasks: ve.getSubtreeTasks(n, o), links: ve.getSubtreeLinks(n, o) }), !e.deleteAfterConfirmation || (e.setGanttMode("tasks"), e.setUpdated(o, true, "deleted"), false);
...
var un = class {
  ...
  ignore(t, e) {
    this._silent_mode = true, t.call(e || dt), this._silent_mode = false;
  }
  setUpdated(t, e, n) {
...
function ai(t) {
  ...
  return t.$services.getService("state").registerProvider("batchUpdate", function() {
    ...
    if (n) o(l);
      ...
      for (var p in r.call(this, g), n = true, this.callEvent("onBeforeBatchUpdate", []), o(l), this.callEvent("onAfterBatchUpdate", []), s.call(this), h) this.resetProjectDates(h[p]);
  ...
  const e = /* @__PURE__ */ function(i) {
    return { _needRecalc: true, reset: function() {
      ...
      i.eachTask(function(r) {
        ...
        if (a) return a = false, void this._setWBSCode(r, "1");
...
function di(t) {
  ...
  function u(f, k) {
    ...
    var x = Number(f.delay), $ = false;
    if (isNaN(x) ? (f.delay = 0, $ = true) : f.delay = x, t.defined(f.value) || (f.value = null), !f.task_id || !f.resource_id) return false;
  ...
  function p(f) {
    ...
    let w = o === n;
    if (t.defined(x) && x) {
      Array.isArray(x) || (x = [x], w && (o = i, w = false));
      const S = {};
      x.forEach(function(T) {
        T.resource_id || (T = { resource_id: T }, w && (o = a, w = false)), w && (T.id && T.resource_id ? (o = s, w = false) : (o = r, w = false));
        let E, C = c;
        T.mode || (T.start_date && T.end_date || T.start_date && T.duration) && (C = d), E = T.id || !T.$id || S[T.$id] ? T.id && !S[T.id] ? T.id : t.uid() : T.$id, S[E] = true;
  ...
  function _(f, k) {
    var x = function($, w) {
      ...
      if (o == i) {
        var T = $[0], E = T ? T.resource_id : null, C = false;
        w.forEach(function(A) {
          A.resource_id != E ? S.inStoreNotInTask.push(A) : A.resource_id == E && (S.inBoth.push({ store: A, task: T }), C = true);
    ...
    x.inStoreNotInTask.forEach(function($) {
      ...
      if (function(S, T) {
        var E = { id: true };
        for (var C in S) if (!E[C] && String(S[C]) !== String(T[C])) return true;
        return false;
  ...
  t.$data.assignmentsStore = h, t.attachEvent("onGanttReady", function() {
    if (t.config.process_resource_assignments) {
      ...
      t.attachEvent("onBeforeBatchUpdate", function() {
        ...
        var C = b(E);
        return h.parse(C), v(E, C), true;
      }), t.attachEvent("onAfterTaskUpdate", function(E, C) {
        f ? (k = true, x[E] = C) : C.unscheduled || m(C);
        ...
        return w = null, S = null, T = null, h.clearAll(), true;
      ...
      h.attachEvent("onStoreUpdated", function() {
        return f && !$ || (w = null, S = null, T = null), true;
...
var _n = function(t) {
  return { getWorkHoursArguments: function() {
    var e = arguments[0];
    if (!bt((e = Z(e) ? { date: e } : P({}, e)).date)) throw t.assert(false, "Invalid date argument for getWorkHours method"), new Error("Invalid date argument for getWorkHours method");
    return e;
    ...
    if ((e = n.date ? new ae(n.date, n.unit, n.task, null, n.calendar) : new ae(arguments[0], arguments[1], arguments[2], null, arguments[3])).unit = e.unit || t.config.duration_unit, !bt(e.date)) throw t.assert(false, "Invalid date argument for isWorkTime method"), new Error("Invalid date argument for isWorkTime method");
    return e;
  }, getClosestWorkTimeArguments: function(e) {
    var n, i = arguments[0];
    if (i instanceof re) return i;
    if (n = Z(i) ? new re(i) : new re(i.date, i.dir, i.unit, i.task, null, i.calendar), i.id && (n.task = i), n.dir = i.dir || "any", n.unit = i.unit || t.config.duration_unit, !bt(n.date)) throw t.assert(false, "Invalid date argument for getClosestWorkTime method"), new Error("Invalid date argument for getClosestWorkTime method");
    return n;
  }, _getStartEndConfig: function(e) {
    var n, i = pi;
    if (e instanceof i) return e;
    if (Z(e) ? n = new i(arguments[0], arguments[1], arguments[2], arguments[3]) : (n = new i(e.start_date, e.end_date, e.task), e.id !== null && e.id !== void 0 && (n.task = e)), n.unit = n.unit || t.config.duration_unit, n.step = n.step || t.config.duration_step, n.start_date = n.start_date || n.start || n.date, !bt(n.start_date)) throw t.assert(false, "Invalid start_date argument for getDuration method"), new Error("Invalid start_date argument for getDuration method");
    if (!bt(n.end_date)) throw t.assert(false, "Invalid end_date argument for getDuration method"), new Error("Invalid end_date argument for getDuration method");
    return n;
...
ye.prototype = { units: ["year", "month", "week", "day", "hour", "minute"], _clearCaches: function() {
  ...
  if (!(t instanceof ye)) return false;
  ...
  for (var o = 0, l = [], d = 0; a < e; ) {
    ...
    if (l.length && d) if (l[l.length - 1].end <= p && g > d) a += d, i = this.$gantt.date.add(i, -1, "day");
      ...
      for (var y = false, v = null, b = null, _ = l.length - 1; _ >= 0; _--) if (l[_].start < p - 1 && l[_].end >= p - 1) {
  ...
  for (var s = 0, o = [], l = 0, d = this._isMinutePrecision(i); a < e; ) {
    ...
    if (o.length && l) if (o[0].start >= h && u >= l) {
      ...
      for (var g = false, p = null, y = 0; y < o.length; y++) if (o[y].start <= h && o[y].end > h) {
        g = true, p = o[y];
        break;
      }
...
var It = { isLegacyResourceCalendarFormat: function(t) {
  if (!t) return false;
...
var bi = (Wt = {}, { getCalendarIdFromMultipleResources: function(t, e) {
  var n = function(a) {
...
fn.prototype = { _calendars: {}, _convertWorkTimeSettings: function(t) {
  ...
  if (e.resource_calendars) {
    var n;
    if (n = this._legacyConfig === false ? e.resource_property : It.getResourceProperty(e), Array.isArray(t[n])) e.dynamic_resource_calendars ? i = bi.getCalendarIdFromMultipleResources(t[n], this) : a = this.getResourceCalendar(t[n]);
  ...
  t._init_task_timing = function(s) {
    ...
    if (s) {
      ...
      if (l || d.start_date && d.end_date && (u.$no_start || u.$no_end)) {
        ...
        t.resetProjectDates(d), l || g != d[y].valueOf() || p != d[v].valueOf() || (h = false), h && !o && this.refreshTask(d.id, true), u.scheduled_summary && (h = true);
      }
...
function ra(t) {
  ...
  var a = function(l) {
    ...
    function c(u, h) {
      ...
      for (var p = { passive: false }, y = 0; y < g.length; y++) R(function(v) {
    ...
    return c.prototype = { traceDragEvents: function(u, h) {
      ...
      if (l.config.touch) {
        var g = h(u), p = g.target || g.srcElement, y = p.cloneNode(true);
      ...
      this.config && this.config.started || (this.config = { obj: u, marker: null, started: false, pos: this.getPosition(h), sensitivity: 4 }, this._settings && P(this.config, this._settings, true), this.traceDragEvents(u, g), l._prevent_touch_scroll = true, h.target.closest(".gantt_row") && !l.config.order_branch && (l._prevent_touch_scroll = false), document.body.classList.add("gantt_noselect"), l.config.touch && this.dragMove(u, h, g.accessor));
      ...
      return this.config.ignore ? false : h.targetTouches && !p.target ? void 0 : (p.pos = this.getPosition(p), this.config.marker.style.left = p.pos.x + "px", this.config.marker.style.top = p.pos.y + "px", this.callEvent("onDragMove", [u, p]), true);
    }, dragEnd: function(u) {
  ...
  var r = /* @__PURE__ */ function(l) {
    ...
    return { initTemplates: function() {
      ...
      c("date_scale", true, void 0, l.config, l.templates), c("date_grid", true, "grid_date_format", l.config, l.templates), c("task_date", true, void 0, l.config, l.templates), l.mixin(l.templates, { xml_format: void 0, format_date: p, xml_date: void 0, parse_date: y, progress_text: function(v, b, _) {
        return "";
  ...
  s.registerProvider("global", function() {
    ...
    var c, u = l.createDatastore({ name: "task", type: "treeDatastore", rootId: function() {
      ...
      return f && !W(_.open) && (_.$open = f.$open), _.parent === void 0 && (_.parent = this.config.root_id), _.open && (_.$open = true), _;
    ...
    function g(_) {
      ...
      if (!m && l.isTaskExists(_)) {
        var f = l.getParent(_);
        l.isTaskExists(f) && l.isTaskVisible(f) && (f = l.getTask(f), l.isSplitTask(f) && (m = true));
      }
      return m;
    }
    function p(_) {
    ...
    l.attachEvent("onDestroy", function() {
      ...
      if (l.config.start_date && l.config.end_date) {
        ...
        if (f = l.config.start_date.valueOf(), k = l.config.end_date.valueOf(), +m.start_date > k || +m.end_date < +f) return false;
      }
      return true;
      ...
      return !Rt(_, l, u) || (console.log("The placeholder task cannot be moved to another position."), false);
      ...
      if (f == "delete" && l._update_flags(_, null), !l.$services.getService("state").getState("batchUpdate").batch_update) {
        ...
        f == "add" || f == "move" || f == "delete" ? l.$layout && (this.$config.name != "task" || f != "add" && f != "delete" || this._skipTaskRecalculation != "lightbox" && (this._skipTaskRecalculation = true), l.$layout.resize()) : _ || h.refresh();
      }
      ...
      return c[_] = ve.getSubtreeLinks(l, _), true;
...
function sa(t) {
  ...
  function a(_) {
    if (n) {
      var m = _.which || _.keyCode, f = false;
      if (v.keyboard) {
        if (m == 13 || m == 32) {
          var k = _.target || _.srcElement;
          X(k).indexOf("gantt_popup_button") > -1 && k.click ? k.click() : (i(n, true), f = true);
        }
        m == 27 && (i(n, false), f = true);
      }
      return f ? (_.preventDefault && _.preventDefault(), !(_.cancelBubble = true)) : void 0;
    }
  }
  ...
  v.seed = (/* @__PURE__ */ new Date()).valueOf(), v.uid = st, v.expire = 4e3, v.keyboard = true, v.position = "top", v.pull = {}, v.timers = {}, v.hideAll = function() {
...
var da = /* @__PURE__ */ function(t) {
  return function(e) {
    ...
    function a(h) {
      h = h || window.event;
      var g = e.locate(h), p = s(h, n.click), y = true;
...
var ua = function(t) {
  var e = /* @__PURE__ */ function(n) {
    ...
    function s(o, l, d) {
      ...
      var y = l.filter;
      return d && d.setAttribute(n.config.layer_attribute, true), a[o] = { render_item: function(v, b, _, m, f) {
        if (b = b || d, !y || y(v)) {
        ...
        if (_ && _.$getConfig().smart_rendering && !Nt(n) && this.rendered && (h || p)) {
          ...
          var $ = {}, w = {};
          for (var S in this.rendered) w[S] = true, $[S] = true;
          for (var T = {}, E = (S = 0, v.length); S < E; S++) {
            var C = v[S], D = this.rendered[C.id];
            w[C.id] = false, D && D.parentNode ? (p ? p(C, k, _, m, n) : We(k, h(C, _, m, n))) ? (u && u.call(n, C, D, _, m, k), this.restore(C, f)) : w[C.id] = true : (T[v[S].id] = true, this.render_item(v[S], f, k, _, m));
          }
...
function mn() {
  ...
  return function(r, s, o, l, d) {
    (function(p) {
      a || (a = true, p.attachEvent("onPreFilter", n), p.attachEvent("onStoreUpdated", n), p.attachEvent("onClearAll", n), p.attachEvent("onBeforeStoreUpdate", n));
    })(l), e || i(l, s, r);
...
var Ht = function() {
  ...
  return t.prototype.destructor = function() {
    ...
    typeof e == "string" && (e = [e]);
    var r = {};
    for (a = 0; a < e.length; a++) wt(i, e[a]), r[e[a]] = true;
    n._currentBorders = r;
...
var kn = function(t) {
  ...
  return z(e, t), e.prototype.destructor = function() {
    ...
    const o = [];
    function l(p) {
      p.$parent.show(), a = true, r.push(p);
    }
    function d(p) {
      p.$parent.hide(), a = true, s.push(p);
    }
    ...
    for (o = 0; o < this.$cells.length; o++) if (!(a = this.$cells[o]).$config.hidden) {
      ...
      this._xLayout ? (g = this._calcSize(r.width, r, true), p = i - 2 * s) : (g = n - 2 * s, p = this._calcSize(r.height, r, false)), a.setSize(g, p);
    }
  }, e;
}(Ht);
var _a = function(t) {
...
var fa = function(t) {
  ...
  return z(n, t), n.prototype.init = function(a) {
    ...
    mt.isFF ? this.$domEvents.attach(this._getRootParent().$view, "wheel", this._mouseWheelHandler, { passive: false }) : this.$domEvents.attach(this._getRootParent().$view, "mousewheel", this._mouseWheelHandler, { passive: false });
    ...
    if (this._checkWheelTarget(r)) {
      ...
      if (y !== false && e.indexOf(y) >= 0 && (!a[y] || a.deltaX || a.wheelDeltaX || (g = 2 * p, p = 0)), g && Math.abs(g) > Math.abs(p)) {
        ...
        if (this.scrollVertically(f), this.$scroll_ver.scrollTop = f, m == this.$scroll_ver.scrollTop) return true;
...
var va = class {
  ...
  attachEvents() {
    this._dnd.attachEvent("onBeforeDragStart", (e, n) => {
      ...
      if (this.$grid.callEvent("onColumnDragMove", [{ draggedColumn: r, targetColumn: s, draggedIndex: i, targetIndex: n }]) === false) return this.cleanTargetMarker(), void this.$gantt.render();
...
xe.prototype = { init: function(t) {
  ...
  var d = function(c, u) {
    var h = { row_before_start: c.bind(function(g, p, y) {
      ...
      if (!et(y, v.task_grid_row_resizer_attribute)) return false;
      ...
      return (S = $ - w) < T && (S = T), _.marker.style.left = x.x + "px", _.marker.style.top = w - 1 + "px", _.marker.style.height = Math.abs(S) + 1 + "px", _.marker_height = S, u.callEvent("onRowResize", [m, v.getItem(m), S + f]), true;
      ...
      u.callEvent("onBeforeRowResizeEnd", [_, m, k]) !== false && m.row_height != k && (m.row_height = k, v.updateItem(_), u.callEvent("onAfterRowResize", [_, m, f, k]), this.render());
    }, c) };
  ...
  for (var c = 0; c < a.length; c++) {
    ...
    let f = false;
    t.config.external_render && t.config.external_render.isElement(_) && (f = true, d[h.name] = _);
    ...
    switch (h) {
      ...
      case u.TAB:
        if (t.isVisible()) {
          ...
          var p = t.getState();
          p.id && r.focus({ type: "taskCell", id: p.id, column: p.columnName }), o.preventDefault(), g = true;
        }
        break;
      default:
...
function Da(t) {
  ...
  var i = { init: Ca, createEditors: function(a) {
    ...
    var s = Ea(t), o = [], l = [], d = null, c = { _itemId: null, _columnName: null, _editor: null, _editorType: null, _placeholder: null, locateCell: function(u) {
      ...
      if (this.callEvent("onBeforeEditStart", [g]) === false) return void this.callEvent("onEditPrevent", [g]);
...
function bn(t) {
  function e(r, s, o) {
    ...
    if (y && v && r.bar_height !== "full" && r.bar_height < r.row_height) if (u === d.types.milestone) {
      let T = s.getBarHeight(r.id, true), E = Math.sqrt(2 * T * T);
...
<path d="M5.58397 1.52543C5.78189 1.22856 6.21811 1.22856 6.41602 1.52543L10.5475 7.72265C10.769 8.05493 10.5308 8.5 10.1315 8.5L1.86852 8.5C1.46917 8.5 1.23097 8.05493 1.45249 7.72265L5.58397 1.52543Z" fill="var(--dhx-gantt-progress-handle-background)" stroke="var(--dhx-gantt-progress-handle-border)"/>
    ...
    return (w || S) && (d.drag_resize && !t.isSummaryTask(r) && u != d.types.milestone && a(b, "gantt_task_drag", r, function(T) {
      ...
      var D = false;
      return $.link_source_id && d.touch && (D = true), C.style.display = D ? "block" : "", E.appendChild(C), E;
    }, d, g)), b;
  }
  function n(r, s, o, l) {
    if (!s) return null;
...
function oe(t, e, n, i) {
  var a = e.width[t];
  if (a <= 0) return false;
  if (!i.config.smart_rendering || Nt(i)) return true;
...
function Ia(t) {
  ...
  function i(a, r, s) {
    ...
    let l = function(p, y, v, b) {
      let _ = b || y.$task_data.scrollHeight, m = false, f = false;
    ...
    if (g) {
      let p = r.getBarHeight(a.id, true);
...
function Na(t) {
  ...
  return t.$data.tasksStore.attachEvent("onStoreUpdated", function() {
    ...
    return o = e[s] ? e[s] : e[s] = function(l, d, c, u) {
      let h, g = false, p = {};
      t.config.process_resource_assignments && d === t.config.resource_property ? (h = l.$role == "task" ? t.getResourceAssignments(l.$resource_id, l.$task_id) : t.getResourceAssignments(l.id), g = true) : h = l.$role == "task" ? [] : t.getTaskBy(d, l.id), p = function(w, S, T) {
        ...
        for (let I = 0; I < w.length; I++) {
          ...
          for (M[Q.id] = {}; H < O; ) {
            ...
            H = t.date.add(H, C, E), J[B] !== false && (D[B] || (D[B] = { tasks: [], assignments: [] }), D[B].tasks.push(N), T && D[B].assignments.push(A));
          }
        }
        return D;
      }(h, c, g);
...
var La = { init: function(t, e) {
  ...
  if (e.$config.bind && t.getDatastore(e.$config.bind)) {
    ...
    t.defined(e.$getConfig().dnd_sensitivity) && (i.config.sensitivity = e.$getConfig().dnd_sensitivity), i.attachEvent("onBeforeDragStart", t.bind(function(o, l) {
      var d = a(l);
      if (!d || (t.hideQuickInfo && t.hideQuickInfo(), ct(l.target, ".gantt_grid_editor_placeholder"))) return false;
      ...
      if (p.exists(_) || (_ = i.lastTaskOfLevel(g.order_branch_free ? v.$level : 0)) == i.config.id && (_ = null), p.exists(_)) {
        ...
        if (k + x / 2 < b) {
          ...
          if (!p.hasChild(f.id)) return f.$open = true, void p.move(v.id, -1, f.id);
...
function le(t, e, n, i) {
  return xn(t, e, n, i, true);
}
function Ge(t, e, n, i) {
  return xn(t, e, n, i, false);
}
  ...
  return { extend: function(e) {
    ...
    return t = function(i, a) {
      ...
      return { drag: null, dragMultiple: {}, _events: { before_start: {}, before_finish: {}, after_finish: {} }, _handlers: {}, init: function() {
        ...
        this._handlers[l].apply(this, [p, s, d, u]), a.mixin(h, p, true), a.callEvent("onTaskDrag", [h.id, l, p, g, c]), a.mixin(h, p, true), a.refreshTask(o);
          ...
          if (this._handlers[o.mode]) {
            if (o.mode === l.drag_mode.move) {
              ...
              if (a.isSummaryTask(h) && a.config.drag_project) {
                var y = {};
                y[o.id] = q(o), p = true, g = P(y, this.dragMultiple);
              }
              ...
              for (var b in g) {
                var _ = g[b];
                p && _.id != o.id && (a._bulk_dnd = true), this._update_item_on_move(u, _.id, _.mode, _, s, m);
              }
              a._bulk_dnd = false;
        ...
        } else if (this.clear_drag_state(), s == l.id && (l.obj._dhx_changed = false, a.mixin(c, l.obj, true)), a.refreshTask(c.id), c.$level > 100) {
          let h = false;
          a.eachParent(function(g) {
            if (!h && g.type === a.config.types.project) {
              const p = { start_date: g.start_date, end_date: g.end_date };
              a.resetProjectDates(g), +p.start_date == +g.start_date && +p.end_date == +g.end_date || (h = true);
            }
...
var Oa = function(t, e) {
  ...
  g.attachEvent("onBeforeDragStart", e.bind(function(m, f) {
    ...
    if (pt(k, u)) {
      pt(k, "task_start_date") && (s = true);
      var x = e.locate(f);
      r = x;
      var $ = e.getTask(x);
      return e.isReadonly($) ? (v(), false) : (this._dir_start = { x: g.config.original_element_sizes.x + g.config.original_element_sizes.width / 2, y: g.config.original_element_sizes.y + g.config.original_element_sizes.height / 2 }, true);
    }
    return false;
    ...
    var $ = !!pt(f, h), w = i, S = n, T = a, E = e.locate(f), C = true;
    if (Y(yt(f), e.$root) || ($ = false, E = null), $ && (C = !pt(f, "task_end_date"), $ = !!E), i = E, n = $, a = C, $) {
    ...
    var D = !(S == $ && w == E && T == C);
    return D && (w && e.refreshTask(w, false), E && e.refreshTask(E, false)), D && y(k.marker), b(this._dir_start.x, this._dir_start.y, this._dir_end.x, this._dir_end.y), true;
...
var za = function(t) {
  ...
  return { onCreated: function(n) {
    ...
    this._mouseDelegates.delegate("click", "gantt_task_link", n.bind(function(a, r) {
      ...
      return s.parentNode && X(s.parentNode) && (l = X(s.parentNode).indexOf("_left") > -1 ? o.$target[0] : o.$source[0]), l && i.call(this, l, a), false;
    }, n), this.$task);
  ...
  var i = function(r) {
    ...
    return { getDataRender: function(o) {
      ...
      var l = o.name, d = o.defaultContainer, c = o.defaultContainerSibling, u = s.createGroup(d, c, function(h, g) {
        ...
        for (var p = 0; p < u.filters.length; p++) if (u.filters[p](h, g) === false) return false;
      }, ha);
    ...
    return function(r) {
      ...
      return { render: function(c, u, h, g) {
        ...
        for (var k = _.start; k <= _.end; k++) {
          var x = b[k];
          if (m[k] = false, x) if (oe(k, v, p, r)) if (o[c.id] && o[c.id][k]) o[c.id] && o[c.id][k] && !o[c.id][k].parentNode && u.appendChild(o[c.id][k]);
          else {
            var $ = l(c, x, y, 0, h);
        ...
        for (var f in m) m[f] !== false && d(c.id, f);
...
function Fa(t) {
  var e = null, n = false, i = null, a = { started: false }, r = {};
  function s(g) {
  ...
  function d(g) {
    g ? (l(true), a.started || (a.x = r.x, a.y = r.y, a.started = true)) : (e && (clearInterval(e), e = null), l(false), a.started = false);
  }
  function c(g) {
    var p = o();
    if (!e && !i || p || d(false), !t.config.autoscroll || !p) return false;
    r = { x: g.clientX, y: g.clientY }, g.type == "touchmove" && (r.x = g.targetTouches[0].clientX, r.y = g.targetTouches[0].clientY), !e && p && d(true);
  }
  function u() {
...
var Va = ["ctrlKey", "altKey", "shiftKey", "metaKey"];
var Ua = [[{ unit: "month", date: "%M", step: 1 }, { unit: "day", date: "%d", step: 1 }], [{ unit: "day", date: "%d %M", step: 1 }], [{ unit: "day", date: "%d %M", step: 1 }, { unit: "hour", date: "%H:00", step: 8 }], [{ unit: "day", date: "%d %M", step: 1 }, { unit: "hour", date: "%H:00", step: 1 }]];
var qa = class {
  constructor(e) {
    this.zoomIn = () => {
...
function Ga(t) {
  ...
  t._touch_events = function(r, s, o) {
    var l, d = 0, c = false, u = false, h = null, g = null, p = null, y = [], v = null;
    let b = {};
    ...
    (a = []).push([t.$container, r[0], function(f) {
      ...
      if (!o(f) && c) {
        g && clearTimeout(g);
        var x = s(f);
        if (k && (k.drag.id || k.drag.start_drag)) return k.on_mouse_move(x), f.preventDefault && f.preventDefault(), f.cancelBubble = true, false;
        if (!t._prevent_touch_scroll) {
          if (x && h) {
            var $ = h.pageX - x.pageX, w = h.pageY - x.pageY;
            if (!u && (Math.abs($) > 5 || Math.abs(w) > 5) && (u = true, d = 0, l = v ? n(v) : t.getScrollState()), u) {
              var S, T = l.x + $, E = l.y + w;
              if (v ? (function(C, D, M) {
    ...
    for (a.push([this.$container, "contextmenu", function(f) {
      ...
      if (b = f.touches.length, document && document.body && document.body.classList.add("gantt_touch_active"), !o(f)) if (f.touches && f.touches.length > 1) c = false;
      else {
        h = s(f), v = function(x) {
        ...
        g = setTimeout(function() {
          ...
          }(x), k._start_dnd(h), t._touch_drag = true, t.refreshTask(x), t._touch_feedback())), g = null;
        }, t.config.touch_drag);
      }
      ...
      if (document && document.body && document.body.classList.remove("gantt_touch_active"), !o(f)) {
        ...
        }), t._touch_feedback())), c = u = false, y = [], p = null, h && d) {
    ...
    function m(f) {
      return f && f.preventDefault && f.cancelable && f.preventDefault(), f.cancelBubble = true, false;
    }
  };
}
function Ft() {
  ...
  function i(a, r) {
    ...
    r && (s = t.getTaskByTime(), a.allow_root && s.unshift({ id: t.config.root_id, text: a.root_label || "" }), s = function(u, h, g) {
      ...
      for (var y = 0; y < u.length; y++) {
        var v = u[y];
        (v.id == g || t.isChildOf(v.id, g) || p(v.id, v) === false) && (u.splice(y, 1), y--);
      }
      return u;
...
function Ja(t) {
  var e = function() {
    ...
    return z(f, m), f.prototype.render = function(k) {
      ...
      return w += x, k.single_date ? (x = _.form_blocks.getTimePicker.call(this, k, true), w += "<span></span>") : w += "<span class='gantt_section_time_spacer'> &nbsp;&ndash;&nbsp; </span>", (w += x) + "</div>";
      ...
      return w = _.form_blocks.getTimePickerValue(S, $), typeof _._resolve_default_mapping($) == "string" ? w : { start_date: w, end_date: function(E, C, D) {
        ...
        return M <= D && ($.autofix_end !== false || $.single_date) ? _.date.add(D, _._get_timepicker_step(), "minute") : M;
      }(S, T, w) };
    }, f.prototype.focus = function(k) {
    ...
    return z(f, m), f.prototype.render = function(k) {
      ...
      else k.single_value = true, $ += "<label><input type='checkbox' name='" + k.name + "'></label>";
      return $ += "</div>", $;
    }, f.prototype.set_value = function(k, x, $, w) {
      var S = Array.prototype.slice.call(k.querySelectorAll("input[type=checkbox]"));
      !k._dhx_onchange && w.onchange && (k.onchange = w.onchange, k._dhx_onchange = true), w.single_value ? S[0].checked = !!x : kt(S, function(T) {
    ...
    return z(f, m), f.prototype.render = function(k) {
      ...
      var S;
      w.options && w.options.length && (S = k.querySelector("input[type=radio][value='" + x + "']") || k.querySelector("input[type=radio][value='" + w.default_value + "']")) && (!k._dhx_onchange && w.onchange && (k.onchange = w.onchange, k._dhx_onchange = true), S.checked = true);
    }, f.prototype.get_value = function(k, x) {
    ...
    return z(f, m), f.prototype.render = function(w) {
      ...
      O[0].onclick = _.bind(function() {
        ...
        var B;
        return (B = (J = J || window.event).charCode || J.keyCode || J.which) == _.constants.KEY_CODES.DOWN ? (Q(-1 * _.config.duration_step), false) : B == _.constants.KEY_CODES.UP ? (Q(1 * _.config.duration_step), false) : void window.setTimeout(H, 1);
    ...
    function x(S, T, E, C) {
      ...
      H.querySelector(".baseline_delete_button").onclick = function(ut) {
        ...
        var U;
        return (U = (ut = ut || window.event).charCode || ut.keyCode || ut.which) == _.constants.KEY_CODES.DOWN ? (Ot(-1 * _.config.duration_step), false) : U == _.constants.KEY_CODES.UP ? (Ot(1 * _.config.duration_step), false) : void window.setTimeout(gt, 1);
...
<div class="gantt_cal_ltitle_controls">
  ...
  t._init_lightbox_events = function() {
    ...
    if (this.getState().lightbox) {
      ...
      this.resetLightbox();
      var $ = this.mixin(x, k, true), w = this.getLightbox(_ || void 0);
