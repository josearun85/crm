...
export default function StepModal({ step, onClose, onSave }) {
  ...
  const handleSave = async () => {
    ...
    await updateOrderStep(step.id, updates);
          ...
          <input
            ...
            onBlur={async () => {
              if (editedDescription.trim() && editedDescription !== step.description) {
                await updateOrderStep(step.id, { description: editedDescription.trim() });
                    ...
                    if (confirmed) {
                      ...
                      if (fileToDelete) {
                        try {
                          ...
                          await updateOrderStep(step.id, { files: updatedFileList });
